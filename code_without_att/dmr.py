...
class DmrFcnAttention(Module):
    def __init__(self, eb_size=128):
        ...
        self.att = nn.Sequential(#PrintLayer(),
                                 ...
                                 #PrintLayer(),
                                 nn.Dropout(0.2),
                                 nn.Linear(self.eb_size*8, 256),#80
                                 #PrintLayer(),
                                 nn.BatchNorm1d(50),
                                 #PrintLayer(),
                                 nn.Sigmoid(),
    ...
    def forward(self, item_eb, item_his_eb, mask):
        ...
        #print('no_softmax:', scores_no_softmax)
...
class ItemAttention(Module):
    def __init__(self, eb_size=128):
        ...
        self.att = nn.Sequential(#PrintLayer(),
                                 #nn.BatchNorm1d(20),
                                 #PrintLayer(),
                                 nn.Linear(self.eb_size*2+32, 32),
                                 #PrintLayer(),
                                 #nn.BatchNorm1d(20),
                                 #PrintLayer(),
                                 nn.Sigmoid(),
...
class DMR(Module):
    ...
    def forward(self, his_outfit_text, his_outfit_visual, mask, outfit_text, outfit_visual, outfit_his_mask, outfit_mask):
        # pre deal
        # print(source.size())
        ...
        #print(his_outfit_text_dm)
        #print(his_outfit_visual_dm)
        #print(outfit_text_dm.size())
        #print(outfit_his_mask.size())
        #print(outfit_mask.size())

        his_outfit_text_dm = torch.sum(his_outfit_text_dm, 2)
        his_outfit_visual_dm = torch.sum(his_outfit_visual_dm, 2)
        outfit_his_mask = torch.sum(outfit_his_mask, -1).unsqueeze(-1)

        outfit_text_dm = torch.sum(outfit_text_dm, 2)
        outfit_visual_dm = torch.sum(outfit_visual_dm, 2)
        outfit_mask = torch.sum(outfit_mask, -1).unsqueeze(-1)
        ...
        #outfit_feat = his_outfit_encode.data.cpu().numpy()
        #np.save('outfit_feat.npy',outfit_feat)
        ...
        his_outfit_dm = his_outfit_encode
        outfit_dm = outfit_encode.squeeze(1)
        #print(his_outfit_dm)
        #print(outfit_dm)
